...
pic_url = '/Users/mahiru/Desktop/myTest/'
...
def mouseClick(clickTimes, lOrR, img, reTry):
    ...
    if reTry == 1:
        while True:
            location = pyautogui.locateCenterOnScreen(img, grayscale=False, confidence=confidence)
...
if __name__ == '__main__':
    file = '/Users/mahiru/Desktop/myTest/cmd.xls'
    # 打开文件
